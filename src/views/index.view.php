            ...
            <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                        <div class="row g-4">
                            <?php foreach ($meals_1 as $meal) : ?>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded" src="img/<?= $meal['image'] ?>" alt=""
                                            style="width: 80px;">
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            ...
                                            <a type="button" href="/items?id=<?= $meal['id'] ?>"
                ...
                <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <form method="POST" action="/booking">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="special_request" placeholder="Special Request" id="message"
                            ...
                            <div class="col-12">
                                <?php if (!Session::get('user')) : ?>
                                    <a href="/login" class="btn btn-primary w-100 py-3" type="submit">please login to book</a>
